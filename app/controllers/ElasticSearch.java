...
public class ElasticSearch extends Controller {
	...
	public static Result search() {
	    return ok(elasticsearch.render("please enter your search term(s)"));
	  }
   
	public static Result elasticsearchresults(){
	  ...
	  List<String>results = SearchElasticSearch.search(searchterm.term1, searchterm.term2);
	  ...
	  return ok(views.html.elasticsearchresults.render(message1, message2, ls));
